...
auth_file_path = "TTS/conf/tcloud_auth.ini"
param_file_path = "TTS/conf/request_parameter.ini"
...
class authorization:
    ...
    def init(self):
        print("init")
        self.conf.read(auth_file_path, encoding="UTF-8")
...
class request:
    ...
    def init(self):
        print("init")
        self.conf.read(param_file_path, encoding="UTF-8")
